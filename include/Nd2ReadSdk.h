...
The Nd2ReadSdk is a set of C functions (and structures) declared in Nd2ReadSdk.h.
 ...
 Nd2ReadSdk is a standalone reimplementation of the ND2 C interface exposed by the
 original SDK. The implementation can access propritary ND2 files
...
#elif defined(__APPLE__) && !defined(LX_STATIC_LINKING)
#  define DLLEXPORT __attribute__((visibility("default")))
#  define DLLIMPORT
#elif defined(__linux__) && !defined(LX_STATIC_LINKING)
#  define DLLEXPORT __attribute__((visibility("default")))
#  define DLLIMPORT
#else
#  define DLLEXPORT
